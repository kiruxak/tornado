...
namespace Tornado.Parser.Data {
    public class AffixRecord : IRecord {
        ...
        public void Parse(string line) {
            ...
            if (values[11].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Ring);
            }
            if (values[12].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Amulet);
            }
            if (values[13].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Belt);
            }
            if (values[14].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Helmet);
            }
            if (values[15].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Gloves);
            }
            if (values[16].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Boots);
            }
            if (values[17].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.BodyArmour);
            }
            if (values[18].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Shield);
            }
            if (values[19].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Quiver);
            }
            if (values[20].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Wand);
            }
            if (values[21].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Dagger);
            }
            if (values[22].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Claw);
            }
            if (values[23].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Sceptre);
            }
            if (values[24].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Staff);
            }
            if (values[25].ContainsPattern("Yes")) {
            ...
            if (values[28].ContainsPattern("Yes")) {
                Tier.ForTypes.Add(ItemType.Mace);
            }
            if (values[29].ContainsPattern("Yes")) {
